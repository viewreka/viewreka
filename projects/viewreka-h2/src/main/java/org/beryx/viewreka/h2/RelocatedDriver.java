 ...
 *      &quot;jdbc:relocated-h2:&tilde;/test&quot;, &quot;sa&quot;, &quot;sa&quot;);
 * </pre>
 */
public class RelocatedDriver implements java.sql.Driver {
    private static final String RELOCATED_START_URL = "jdbc:relocated-h2:";

    private static final RelocatedDriver INSTANCE = new RelocatedDriver();
    ...
    public Connection connect(String url, Properties info) throws SQLException {
        try {
            ...
            if(url.startsWith(RELOCATED_START_URL)) {
				url = Constants.START_URL + url.substring(RELOCATED_START_URL.length());
			}
     ...
     * INTERNAL
     */
    public static synchronized RelocatedDriver load() {
        try {
            if (!registered) {
                registered = true;
    ...
    public static void setThreadContextClassLoader(Thread thread) {
        ...
        try {
            thread.setContextClassLoader(RelocatedDriver.class.getClassLoader());
        } catch (Throwable t) {
            // ignore
        }
    }
