...
/**
 * Abstract facade for H2 databases
 */
@Slf4j
abstract class AbstractH2DB extends EmbeddedDB {
    AbstractH2DB(String driver, String dbPath, String user, String password) {
    ...
    AbstractH2DB withDefaultCreateAndDeleteStrategy() {
