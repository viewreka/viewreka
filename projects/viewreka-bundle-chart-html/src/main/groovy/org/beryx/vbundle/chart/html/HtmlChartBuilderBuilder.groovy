 ...
 */
class HtmlChartBuilderBuilder implements FxChartBuilderBuilder<String> {
    @Override
    public FxChartBuilder<String> build(String chartName, Closure closure, Parameter<?> chartParameter, Map<String, DatasetProvider> currentDataSetProviders) {
